...
class AccoutDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   ...
   /*   floatingActionButton: GestureDetector(
      ...
      body: IdleDetector(
        idleTime: const Duration(seconds: 5),
        onIdle: () {
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  SizedBox(height: 10,),
                  Text("Retrait : ${fetchGoalsController.currentGoal.value.dateOfWithdrawal?.day.toString().padLeft(2, '0')}/${fetchGoalsController.currentGoal.value.dateOfWithdrawal?.month.toString().padLeft(2, '0')}/${fetchGoalsController.currentGoal.value.dateOfWithdrawal?.year}",textAlign: TextAlign.center,style: TextStyle(),),
                  SizedBox(height: 20,),
                  Row(
